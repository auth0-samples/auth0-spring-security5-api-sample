# Auth0 Spring Security 6 API Samples
...
These samples demonstrate how to create an API with Spring Boot 3, which only permits access to resources if a valid **access token** is included.
